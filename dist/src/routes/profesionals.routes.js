...
import { createProfessional, deleteprofessional, getPrivateProfessionals, getprofessionalById, getPublicProfessionals, patchProfesionalSuscripcion, updateprofessional } from "../controllers/professionals.controllers.js";
...
//router.patch("/image/:id",authMiddleware,patchProfesionalImage);
