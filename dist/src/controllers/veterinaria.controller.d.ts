...
export declare const patchEstablecimientoSuscripcion: (req: Request, res: Response) => Promise<void>;
export declare const patchEstablecimientoImagen: import("express").RequestHandler<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs, Record<string, any>>[];
