...
export declare const patchServicioSuscripcion: (req: Request, res: Response) => Promise<void>;
export declare const patchServicioImagen: import("express").RequestHandler<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs, Record<string, any>>[];
